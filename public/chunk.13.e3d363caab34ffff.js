...
var update = __webpack_require__(47)("81dc8fdc", content, true);
...
// module
exports.push([module.i, "$brand-primary:#3c7caa;$brand-dark:#123456;$link-color:#ffa120;@page{size:A4;margin:0}body{font-size:12px;font-family:Helvetica,Tahoma,Arial,Microsoft YaHei,Hiragino Sans GB,WenQuanYi Micro Hei,sans-serif;background:#f4f4f4;margin:0;color:#222}em{font-style:normal;color:$brand-primary}._3AbERnZV8fYvcrkm{display:flex;background:#fff;width:21cm;height:29.7cm;margin:1.6cm auto;box-shadow:$box-shadow-base}@media print{._3AbERnZV8fYvcrkm{margin:0;box-shadow:none}}.YAVTB4xmvPoQvaLZ{width:28%;background:$brand-dark;padding:.72cm .5cm;color:#fff}._1GdWX99e98cTAhoT{width:72%;padding:.72cm}._2s4d2FNheQF-XJJV{display:block}.sM1d0BnWArnKHY3n{display:block;height:102px;border:3px solid #fff}.EAO8klOYfYYk4YzT{background:#eee;margin:0 -.72cm;padding:.3cm .72cm}._3tNNHYefPkAZYQu7{font-family:PingFang SC,sans-serif;font-size:24px;font-weight:400;color:$brand-primary;margin:0;margin-bottom:.1em}._1W63vgbKCBtjpYj-{position:relative;font-size:18px;font-weight:400;margin:.6em 0;color:$brand-primary;border-bottom:1px solid $brand-primary}._1W63vgbKCBtjpYj-:before{position:absolute;content:\"\";display:block;left:0;width:4em;bottom:-2px;border-bottom:3px solid $brand-primary}._1W63vgbKCBtjpYj- small{float:right;font-size:12px;line-height:2.8}._1W63vgbKCBtjpYj-[color=dark]{color:#fff;border-color:#fff}._1W63vgbKCBtjpYj-[color=dark]:before{border-color:#fff}._1lvlERd30SBa9VIq{font-size:14px;margin:.3em 0}._1lvlERd30SBa9VIq:before{content:\"\";display:inline-block;width:6px;height:6px;background:$brand-primary;margin:1px 6px 2px 0}._1MLdcFjn3jV7whBD{margin:.3em 0}._2Rd8pJg3_RRxflbJ{margin:.3em 0;color:$brand-primary}._3LRx3CVUJCEWceD2{font-weight:700}._241IlHcwv6askrZ0{display:inline-block}._241IlHcwv6askrZ0[pull=right]{float:right}.ASUNIDdNqvCqpxRv:before{content:\"\";display:inline-block;width:2px;height:2px;border-radius:100%;background:#000;margin:3px 8px 3px 2px}.ASUNIDdNqvCqpxRv[nowrap]{white-space:nowrap}.YAVTB4xmvPoQvaLZ .ASUNIDdNqvCqpxRv:before{background:#fff}._3_QAIl3onSiqYj3r{color:$link-color;text-decoration:underline}._9dHLvW2k1-AfbP8M{display:block;width:140px;margin:1em auto;margin-top:10.2em}._9dHLvW2k1-AfbP8M+p{text-align:center}", ""]);

// exports
exports.locals = {
	"root": "_3AbERnZV8fYvcrkm",
	"left": "YAVTB4xmvPoQvaLZ",
	"right": "_1GdWX99e98cTAhoT",
	"photo": "_2s4d2FNheQF-XJJV",
	"photo-img": "sM1d0BnWArnKHY3n",
	"header": "EAO8klOYfYYk4YzT",
	"h1": "_3tNNHYefPkAZYQu7",
	"h2": "_1W63vgbKCBtjpYj-",
	"h3": "_1lvlERd30SBa9VIq",
	"p": "_1MLdcFjn3jV7whBD",
	"timeline": "_2Rd8pJg3_RRxflbJ",
	"date": "_3LRx3CVUJCEWceD2",
	"cell": "_241IlHcwv6askrZ0",
	"list": "_3tkQvRT6E18j1H7M",
	"list-item": "ASUNIDdNqvCqpxRv",
	"a": "_3_QAIl3onSiqYj3r",
	"qrcode": "_9dHLvW2k1-AfbP8M"
};
...
const Profile = __WEBPACK_IMPORTED_MODULE_0_u_base_vue__["a" /* default */].extend({
    name: 's-profile'
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_Projects_GitHub_Vusion_vusion_cli_node_modules_vusion_vue_loader_lib_selector_type_script_index_0_Profile_vue__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Projects_GitHub_Vusion_vusion_cli_node_modules_vusion_vue_loader_lib_template_compiler_index_id_data_v_5d5b768a_hasScoped_false_preserveWhitespace_false_Projects_GitHub_Vusion_vusion_cli_node_modules_vusion_vue_loader_lib_selector_type_template_index_0_Profile_vue__ = __webpack_require__(118);
var cssModules = {}
function injectStyle (ssrContext) {
cssModules['$style'] = __webpack_require__(115);  this['$style'] = cssModules['$style']
}
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_Projects_GitHub_Vusion_vusion_cli_node_modules_vusion_vue_loader_lib_selector_type_script_index_0_Profile_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__Projects_GitHub_Vusion_vusion_cli_node_modules_vusion_vue_loader_lib_template_compiler_index_id_data_v_5d5b768a_hasScoped_false_preserveWhitespace_false_Projects_GitHub_Vusion_vusion_cli_node_modules_vusion_vue_loader_lib_selector_type_template_index_0_Profile_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
